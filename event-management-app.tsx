      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-stone-100 to-amber-50 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg border border-stone-200 overflow-hidden">
            ...
            <div className="p-8">
              <h1 className="text-3xl font-light text-stone-900 mb-2">{selectedEvent.name}</h1>
              <div className="flex items-center gap-4 text-stone-700 mb-6">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#886c44] text-white rounded-md hover:bg-[#755a38] transition-all shadow-md"
          >
            <Plus size={20} />
            New Event
          </button>
        ...
        <div className="mt-12 p-6 bg-gradient-to-br from-white to-stone-50 rounded-lg border border-stone-200 shadow-sm">
          <h3 className="text-lg font-medium text-stone-900 mb-2">Google Sheets Integration</h3>
          <p className="text-sm text-stone-700 mb-4">
            All event data automatically syncs to Google Sheets for backup, historical tracking, and benchmarking future events.
          </p>
          <a href="https://docs.google.com/spreadsheets/d/1dLNdvhcW1_36brUdahk_eh73qx127GYM8djHMJbyazg/edit?gid=1826715872#gid=1826715872" target="_blank" rel="noopener noreferrer" className="text-sm text-amber-700 hover:text-amber-800 font-medium transition-colors">
            Connect Google Sheets -></a>
        </div>
      </div>
    </div>
  );
